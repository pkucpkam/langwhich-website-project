package com.langwhich.app.modules.srs.util;
...
public class SrsAlgorithm {
    ...
    public static SrsCard buildNewCard(com.langwhich.app.modules.user.entity.User user,
                                      com.langwhich.app.modules.lesson.entity.Lesson lesson,
                                      com.langwhich.app.modules.vocabulary.entity.VocabularyItem item) {
